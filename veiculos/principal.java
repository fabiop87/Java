...
public class principal {
    public static void main(String[] args) {
        ...
        int Total = 0;
        veiculo carro;
        // como nao consegui colocar os opcionais adicionais no carro já instanciado fiz
        // em um arraylist separado e o valor deles vai ser adicionado no total
        ...
        while (resposta != 0) {
            ...
            System.out.println("Valor do veiculo: " + Total);
            System.out.println("\n\n");
            // zerando o total no final para calcular outro carro sem pausar o programa
            Total = 0;
        }
